<template>
      ...
      <div class="mb-1 w-1/2 sm:w-2/3 flex-wrap text-center">
        ...
        <div v-else>
          ...
          <div class="my-5 flex justify-center gap-4">
              <button class="py-2 px-4 bg-gray-700" @click="$router.go(0)">Ulangi</button>
              <RouterLink to="/comment" class="py-2 px-4 bg-gray-700">Beri Komentar</RouterLink>
          </div>
        </div>  
      </div>
    </div>
  ...
  <script>
  import TableNums from '../components/TableNums.vue';
